...
class StickyAdmin {
    ...
    */
    public static function sticky_functions() {
        ...
        require_once( STICKY_INCLUDES_URI . 'functions.php' );

        // Sticky styles and scripts definitions
        require_once( STICKY_INCLUDES_URI . 'styles.php' );
        require_once( STICKY_INCLUDES_URI . 'scripts.php' );

        // Login page
        require_once( STICKY_INCLUDES_URI . 'login.php' );
    }
    ...
    */
    public static function sticky_vars() {
        self::sticky_setup_options( get_option('options') );
    }
    ...
    public static function sticky_setup_options( $s_ui ) {
        // Syicky Random Cogs
        include ( 'includes/preloaders.php' );
    ...
    public static function sticky_ajax_css() {
        ...
        require( STICKY_INCLUDES_URI . 'ajax_css.php' );
        exit;
    }
